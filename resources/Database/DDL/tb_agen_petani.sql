...
CONSTRAINT ct_agen_agpet_fk FOREIGN KEY (agen) REFERENCES tb_agen (username),
CONSTRAINT ct_petani_agpet_fk FOREIGN KEY (petani) REFERENCES tb_petani (username)
);